...
window.title("Simple Calucaltor")
...
Button(window,text="C",width=5,height=1,font=("arial",30,"bold"), bd=1,fg="#fff",bg="blue",command=lambda:clear()).place(x=10,y=100)
...
Button(window,text="=",width=5,height=3,font=("arial",30,"bold"), bd=1,fg="#fff",bg="#fe9037",command=lambda:Caculate()).place(x=430,y=400)
